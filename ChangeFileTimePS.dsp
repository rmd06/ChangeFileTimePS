...
!MESSAGE "ChangeFileTimePS - Win32 Unicode Debug" (based on "Win32 (x86) Dynamic-Link Library")
!MESSAGE "ChangeFileTimePS - Win32 Release MinSize" (based on "Win32 (x86) Dynamic-Link Library")
!MESSAGE "ChangeFileTimePS - Win32 Release MinDependency" (based on "Win32 (x86) Dynamic-Link Library")
!MESSAGE "ChangeFileTimePS - Win32 Unicode Release MinSize" (based on "Win32 (x86) Dynamic-Link Library")
!MESSAGE "ChangeFileTimePS - Win32 Unicode Release MinDependency" (based on "Win32 (x86) Dynamic-Link Library")
!MESSAGE 
...
!IF  "$(CFG)" == "ChangeFileTimePS - Win32 Debug"
...
OutDir=.\Debug
TargetPath=.\Debug\ChangeFileTimePS.dll
InputPath=.\Debug\ChangeFileTimePS.dll
SOURCE="$(InputPath)"
...
!ELSEIF  "$(CFG)" == "ChangeFileTimePS - Win32 Unicode Debug"
...
# Begin Custom Build - Performing registration
OutDir=.\DebugU
TargetPath=.\DebugU\ChangeFileTimePS.dll
InputPath=.\DebugU\ChangeFileTimePS.dll
SOURCE="$(InputPath)"
...
!ELSEIF  "$(CFG)" == "ChangeFileTimePS - Win32 Release MinSize"
...
TargetPath=.\ReleaseMinSize\ChangeFileTimePS.dll
InputPath=.\ReleaseMinSize\ChangeFileTimePS.dll
SOURCE="$(InputPath)"
...
!ELSEIF  "$(CFG)" == "ChangeFileTimePS - Win32 Release MinDependency"
...
TargetPath=.\ReleaseMinDependency\ChangeFileTimePS.dll
InputPath=.\ReleaseMinDependency\ChangeFileTimePS.dll
SOURCE="$(InputPath)"
...
!ELSEIF  "$(CFG)" == "ChangeFileTimePS - Win32 Unicode Release MinSize"
...
TargetPath=.\ReleaseUMinSize\ChangeFileTimePS.dll
InputPath=.\ReleaseUMinSize\ChangeFileTimePS.dll
SOURCE="$(InputPath)"
...
!ELSEIF  "$(CFG)" == "ChangeFileTimePS - Win32 Unicode Release MinDependency"
...
TargetPath=.\ReleaseUMinDependency\ChangeFileTimePS.dll
InputPath=.\ReleaseUMinDependency\ChangeFileTimePS.dll
SOURCE="$(InputPath)"
...
# Name "ChangeFileTimePS - Win32 Unicode Debug"
# Name "ChangeFileTimePS - Win32 Release MinSize"
# Name "ChangeFileTimePS - Win32 Release MinDependency"
# Name "ChangeFileTimePS - Win32 Unicode Release MinSize"
# Name "ChangeFileTimePS - Win32 Unicode Release MinDependency"
...
SOURCE=.\ChangeFileTimeHandler.rgs
# End Source File
# Begin Source File
